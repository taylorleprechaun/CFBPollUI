...
public class PredictionAlgorithmResolverTests
{
    private readonly PredictionAlgorithmResolver _resolver;
    private readonly PredictionCalculatorModule _v1;
    private readonly PredictionCalculatorModuleV2 _v2;

    public PredictionAlgorithmResolverTests()
    {
        ...
        _v1 = new PredictionCalculatorModule(mockDataService.Object, options);
        _v2 = new PredictionCalculatorModuleV2(mockDataService.Object, options);
        _resolver = new PredictionAlgorithmResolver(_v1, _v2);
    }

    [Fact]
    public void Constructor_NullV1_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() => new PredictionAlgorithmResolver(null!, _v2));
    }

    [Fact]
    public void Constructor_NullV2_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() => new PredictionAlgorithmResolver(_v1, null!));
    }
