...
export const STALE_TIME_ADMIN_PREDICTIONS = 1000 * 60 * 30; // 30 minutes
...
export const STALE_TIME_PREDICTIONS = 1000 * 60 * 5; // 5 minutes
export const STALE_TIME_RANKINGS = 1000 * 60 * 5; // 5 minutes
export const STALE_TIME_RANKINGS_SNAPSHOTS = 1000 * 60 * 30; // 30 minutes
export const STALE_TIME_SEASONS = 1000 * 60 * 60; // 1 hour
export const STALE_TIME_SEASON_TRENDS = 1000 * 60 * 30; // 30 minutes
