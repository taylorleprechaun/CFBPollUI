...
describe('useSeasons', () => {
  ...
  it('refetch after error succeeds', async () => {
    ...
    vi.mocked(global.fetch).mockResolvedValue({
      ok: true,
      json: () => Promise.resolve({ latestPublishedSeason: null, nextSeason: null, seasons: [2024, 2023] }),
    } as Response);
  ...
  it('returns empty array when seasons is empty', async () => {
    vi.mocked(global.fetch).mockResolvedValue({
      ok: true,
      json: () => Promise.resolve({ latestPublishedSeason: null, nextSeason: null, seasons: [] }),
    } as Response);
