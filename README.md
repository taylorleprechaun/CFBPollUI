...
The project includes 1,977 unit and integration tests across backend and frontend.
...
![Frontend Tests](https://img.shields.io/badge/Frontend_Tests-1106-blue)
