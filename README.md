...
The project includes 1,907 unit and integration tests across backend and frontend.
...
![Frontend Tests](https://img.shields.io/badge/Frontend_Tests-1036-blue)
