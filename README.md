...
The project includes 1,893 unit and integration tests across backend and frontend.
...
![Frontend Tests](https://img.shields.io/badge/Frontend_Tests-1022-blue)
